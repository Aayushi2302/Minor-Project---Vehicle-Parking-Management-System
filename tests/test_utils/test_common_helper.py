...
class TestCommonHelper(unittest.TestCase):
    ...
    @patch("utils.common_helper.db")
    @patch('utils.common_helper.hashlib.sha256')
    @patch('utils.common_helper.CommonHelper.regex_validation')
    @patch('utils.common_helper.maskpass.askpass')
    ...
    @patch('utils.common_helper.re.match')
