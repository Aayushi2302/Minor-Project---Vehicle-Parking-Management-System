...
class TestParkingSlot(TestCase):
    ...
    @patch('controller.parking_controller.parking_slot.db')
    @patch('controller.parking_controller.parking_slot.VehicleType.get_vehicle_type_id_from_type_name')
    ...
    @patch('controller.parking_controller.parking_slot.db')
    @patch('controller.parking_controller.parking_slot.ParkingSlot.get_parking_slot_status')
