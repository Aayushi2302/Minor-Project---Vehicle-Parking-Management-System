...
class TestSlotBooking(TestCase):
    ...
    @patch('src.controller.parking_controller.slot_booking.db')
    @patch("src.controller.parking_controller.slot_booking.SlotBooking.get_vacant_parking_slot")
    @patch('src.controller.parking_controller.slot_booking.EmployeeController.get_cust_id_from_vehicle_no')
    ...
    @patch('src.controller.parking_controller.slot_booking.db')
    @patch('src.controller.parking_controller.slot_booking.SlotBooking.calculate_charges')
    @patch('src.controller.parking_controller.slot_booking.SlotBooking.calculate_hours_spent_in_parking')
    @patch('src.controller.parking_controller.slot_booking.SlotBooking.get_details_for_vacating_parking_slot')
