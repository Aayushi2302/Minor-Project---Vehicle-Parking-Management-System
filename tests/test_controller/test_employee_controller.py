...
class TestEmployeeController(TestCase):
    ...
    @patch('controller.employee_controller.db')
    ...
    @patch('controller.employee_controller.db')
    @patch('controller.employee_controller.EmployeeController.get_cust_id_from_vehicle_no')
    ...
    @patch('controller.employee_controller.db')
    @patch('controller.employee_controller.EmployeeController.get_booking_details_from_cust_id')
    @patch('controller.employee_controller.EmployeeController.get_cust_id_from_vehicle_no')
