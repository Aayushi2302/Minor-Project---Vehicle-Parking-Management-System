...
class GetIndividualVehicleTypeController:
    ...
    def get_individual_vehicle_type(self, type_id: str) -> dict:
        """
        ...
        vehicle_type_business_obj.get_individual_vehicle_type(type_id)

        return SuccessResponse.jsonify_data("Vehicle type details fetched successfully."), 200
